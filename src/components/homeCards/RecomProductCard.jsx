...
import ActivityCard from "../propertyCards/ActivityCard";

const RecomProductCard = ({ property }) => {
  const navigate = useNavigate();

  return (
    <Card className="relative overflow-hidden w-[330px] h-full lg:w-[320px] xl:w-[430px] 2xl:w-[400px]">
      <div className="relative h-60 bg-muted flex items-center mb-3 justify-center">
...
export default RecomProductCard;
